      ...
      return (
        <footer className="bg-white text-slate-500 py-16 border-t border-slate-100">
          ...
          <div className="flex justify-center gap-8 mb-10 text-sm font-medium">
            <a href="https://www.aliyun.com/product/esa?spm=5176.42028462.nav-v2-dropdown-menu-1.d_main_4_3_1.35c9154atdjKRv&scm=20140722.X_data-0cdb601aa282ed84fccb._.V_1" target="_blank" rel="noopener noreferrer" className="text-slate-600 hover:text-ali-orange transition-colors">关于阿里云ESA</a>
