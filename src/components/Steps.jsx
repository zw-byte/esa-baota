    ...
    const Steps = () => {
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        <div className="absolute top-1/4 left-[-10%] w-[800px] h-[800px] bg-blue-50/40 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-[-10%] w-[600px] h-[600px] bg-purple-50/30 rounded-full blur-3xl"></div>
        {/* Bottom white mask for seamless transition */}
              ...
              <div className="bg-white rounded-3xl p-8 border border-slate-200 hover:border-ali-orange/30 hover:shadow-lg transition-all duration-300 flex flex-col relative overflow-hidden">
                ...
                <div className="flex-1 flex flex-col justify-center items-center text-center p-6 rounded-2xl border border-dashed border-slate-200">
                  <p className="text-slate-600 leading-relaxed mb-4 text-sm">
                    ...
                    <span className="font-bold text-slate-800">开箱即用</span>
                  </p>
              <span className="inline-block px-6 py-2.5 bg-blue-50 text-blue-600 text-sm rounded-full font-medium">
                敬请期待
              </span>
                </div>
              </div>
